...
void __fastcall TDMod::RESTClient1ReceiveData(TObject* const Sender,
...
void __fastcall TDMod::RESTClient1SendData(TObject* const Sender,
    __int64 AContentLength, __int64 AWriteCount, bool& AAbort)
{
    Application->ProcessMessages();
}
//---------------------------------------------------------------------------

void __fastcall TDMod::RESTClient1ValidateCertificate(TObject* const Sender,
...
void __fastcall TDMod::RESTRequest1BeforeExecute(TCustomRESTRequest* Sender)
{
    Application->ProcessMessages();
}
//---------------------------------------------------------------------------

void __fastcall TDMod::RESTRequest1HTTPProtocolError(TCustomRESTRequest* Sender)
{
    Application->ProcessMessages();
}
//---------------------------------------------------------------------------

void __fastcall TDMod::XMLDocument1AfterNodeChange(
    IXMLNode* const Node, TNodeChange ChangeType)
...
void __fastcall TDMod::XMLDocument1AfterOpen(TObject* Sender)
{
    Application->ProcessMessages();
}
//---------------------------------------------------------------------------

void __fastcall TDMod::XMLDocument1BeforeClose(TObject* Sender)
{
    Application->ProcessMessages();
}
//---------------------------------------------------------------------------

void __fastcall TDMod::XMLDocument1AsyncLoad(
    TObject* Sender, int AsyncLoadState)
...
void __fastcall TDMod::XMLDocument1BeforeOpen(TObject* Sender)
{
    Application->ProcessMessages();
}
//---------------------------------------------------------------------------

void __fastcall TDMod::XMLDocument1BeforeNodeChange(
    IXMLNode* const Node, TNodeChange ChangeType)
...
void __fastcall TDMod::RESTRequest1AfterExecute(TCustomRESTRequest* Sender)
{
    Application->ProcessMessages();
}
//---------------------------------------------------------------------------

void __fastcall TDMod::RESTClient1HTTPProtocolError(TCustomRESTClient* Sender)
{
    Application->ProcessMessages();
}
//---------------------------------------------------------------------------

void __fastcall TDMod::RESTClient1AuthEvent(TObject* const Sender,
    TAuthTargetType AnAuthTarget, const UnicodeString ARealm,
    const UnicodeString AURL, UnicodeString& AUserName,
    UnicodeString& APassword, bool& AbortAuth,
...
void __fastcall TDMod::RESTClient1NeedClientCertificate(TObject* const Sender,
    TURLRequest* const ARequest, TCertificateList* const ACertificateList,
    int& AnIndex)
...
void __fastcall TDMod::RESTClient1ReceiveDataEx(TObject* const Sender,
    __int64 AContentLength, __int64 AReadCount, Pointer AChunk,
    DWORD AChunkLength, bool& AAbort)
